...
ARE_HOME="$test_root/state" "$binary" begin > "$test_root/begin.json" <<JSON
{"task_id":"private-task-marker","workspace":"$workspace"}
JSON
...
ARE_HOME="$test_root/state" "$binary" end > "$test_root/end.json" <<JSON
